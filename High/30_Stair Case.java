...
class H30StairCase
{
  ...
  public static Integer countStepsNew(int[] a , int sum, int n){
    ...
    if(sum < 0 ){
      ...
      return countStepsNew(a, sum, n - 1) + countStepsNew(a, sum - a[n], n);
  ...
  {
      int a[] = {1,2,3};
      //System.out.println(countStepsNew(a,3,a.length-1));
      Integer ans = countStepsNew(a, 3, a.length - 1);
