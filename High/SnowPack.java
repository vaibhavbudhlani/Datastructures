package com.gs.practice;/* Problem Name is &&& Snowpack &&& PLEASE DO NOT REMOVE THIS LINE. */
...
public class SnowPack
{
  ...
  */
  ...
  public static Integer computeSnowPackNew(Integer[] arr){
      int n = arr.length ;
      int l= 0;
      int r =  n-1;
      int lmax = 0;
  ...
  */
  ...
  {
  boolean result = true;
  result &= computeSnowPackNew(new Integer[]{0,1,3,0,1,2,0,4,2,0,3,0}) == 13;
